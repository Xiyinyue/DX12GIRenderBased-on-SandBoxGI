...
// 	由于其作为参数传入, 状态会被初始化为资源的初始状态, 即D3D12_RESOURCE_STATE_COMMON。
// 
// 		所以虽然没有明确赋值, 但mCurrentResourceState会在CreateCommittedResource内部被初始化为默认的资源初始状态。
// 
// 		这与直接赋值mCurrentResourceState = D3D12_RESOURCE_STATE_COMMON; 是等效的。
