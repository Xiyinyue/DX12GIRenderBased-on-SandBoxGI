...
void DXRSExampleGIScene::Init(HWND window, int width, int height)
{
	...
	mRenderableObjects.emplace_back(new DXRSModel(*mSandboxFramework, mSandboxFramework->GetFilePath("content\\models\\sphere_medium.fbx"), true, XMMatrixIdentity() * XMMatrixTranslation(-18.0f, -0.95f, -13.20f), XMFLOAT4(0.3f, 0.8f, 0.426, 0.7f)));
	//mRenderableObjects.emplace_back(new DXRSModel(*mSandboxFramework, mSandboxFramework->GetFilePath("content\\models\\sphere_small.fbx"), true, XMMatrixIdentity() * XMMatrixTranslation(-15.25f, -0.45f, -16.20f), XMFLOAT4(0.5, 0.0, 0.8, 0.75f)));
	...
	mRenderableObjects.emplace_back(new DXRSModel(*mSandboxFramework, mSandboxFramework->GetFilePath("content\\models\\cube.fbx"), true, XMMatrixIdentity() * XMMatrixRotationX(-XM_PIDIV2) * XMMatrixRotationY(-0.907571f) * XMMatrixTranslation(0.0f, 5.0f, -19.0f) , XMFLOAT4(0.7f, 0.0f, 0.1f, 0.7)));
